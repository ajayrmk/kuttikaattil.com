DROP DATABASE IF EXISTS kuttikaattildotcom;

CREATE DATABASE IF NOT EXISTS kuttikaattildotcom;

USE kuttikaattildotcom;
...
(1, 'admin', 'admin address', '02650', 'Kannur', 'India', '7558870853', 'admin@kuttikaattil.com', 'admin', '$2a$10$oKJI.K0j6fHdAEQpcHuC1OoiICoR5ScGzBBOevSKi6/QMz1jXAyGu', 1),
(2, 'user', 'user address', '02650', 'Kannur', 'India', '7558870853', 'user@kuttikaattil.com', 'user', '$2a$10$7VCt87sSFMjl.zmxYkc5h.ziJA9S9zl.XQIwM.ThTKwhq/2jpGYUa', 0);
